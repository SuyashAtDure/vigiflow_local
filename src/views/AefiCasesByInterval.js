...
function AefiCasesByInterval() {
  ...
  const getAllChartsData = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setChartData(response.data[selectedCountry]["AEFI Cases by Interval of Date of Vaccination and Date of Report (# of days)"]);
      }
    } catch (error) {
      setLoading(false);
  ...
  if (!chartData || Object.keys(chartData).length === 0) {
    return <HighchartsReact
      ...
      options={createChartOptions("AEFI Cases by Interval of Date of Vaccination and <br> Date of Report (# of days)", {})}
    />;
  }
  ...
  return (
    <HighchartsReact
      highcharts={Highcharts}
      options={createChartOptions("AEFI Cases by Interval of Date of Vaccination and <br> Date of Report (# of days)", chartData)}
    />
  );
}

export default AefiCasesByInterval;
